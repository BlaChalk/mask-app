          ...
          <div class="modal-body" v-if="currStore">
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <th>早上</th>
                  <td v-for="(s, index) in servicePeriods[0]" :key="index">{{ s }}</td>
                </tr>
                <tr>
                  <th>中午</th>
                  <td v-for="(s, index) in servicePeriods[1]" :key="index">{{ s }}</td>
                </tr>
                <tr>
                  <th>晚上</th>
                  <td v-for="(s, index) in servicePeriods[2]" :key="index">{{ s }}</td>
                </tr>
              </tbody>
            </table>
